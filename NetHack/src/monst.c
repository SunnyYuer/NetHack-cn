 ...
 */
#define MON(enam, nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, d, col) \
    {                                                                      \
        enam, nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, d, C(col)   \
    }
...
NEARDATA struct permonst mons[] = {
     ...
     * ants
     */
    MON("giant ant", "巨型蚂蚁", S_ANT, LVL(2, 18, 3, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        4, CLR_BROWN),
    MON("killer bee", "杀人蜂", S_ANT, LVL(1, 18, -1, 0, 0), (G_GENO | G_LGROUP | 2),
        ...
        5, CLR_YELLOW),
    MON("soldier ant", "兵蚁", S_ANT, LVL(3, 18, 3, 0, 0), (G_GENO | G_SGROUP | 2),
    ...
    MON("fire ant", "火蚁", S_ANT, LVL(3, 18, 3, 10, 0), (G_GENO | G_SGROUP | 1),
    ...
    MON("giant beetle", "巨型甲虫", S_ANT, LVL(5, 6, 4, 0, 0), (G_GENO | 3),
        ...
        6, CLR_BLACK),
    MON("queen bee", "蜂王", S_ANT, LVL(9, 24, -4, 0, 0), (G_GENO | G_NOGEN),
     ...
     * blobs
     */
    MON("acid blob", "酸滴", S_BLOB, LVL(1, 3, 8, 0, 0), (G_GENO | 2),
    ...
    MON("quivering blob", "颤抖的斑点", S_BLOB, LVL(5, 1, 8, 0, 0), (G_GENO | 2),
    ...
    MON("gelatinous cube", "黏胶立方怪", S_BLOB, LVL(6, 6, 8, 0, 0), (G_GENO | 2),
     ...
     * cockatrice
     */
    MON("chickatrice", "小鸡蛇", S_COCKATRICE, LVL(4, 4, 8, 30, 0),
        (G_GENO | G_SGROUP | 1),
    ...
    MON("cockatrice", "鸡蛇", S_COCKATRICE, LVL(5, 6, 6, 30, 0), (G_GENO | 5),
    ...
    MON("pyrolisk", "火鸡蛇", S_COCKATRICE, LVL(6, 6, 6, 30, 0), (G_GENO | 1),
     ...
     * dogs & other canines
     */
    MON("jackal", "豺狼", S_DOG, LVL(0, 12, 7, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        1, CLR_BROWN),
    MON("fox", "狐狸", S_DOG, LVL(0, 15, 7, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        1, CLR_RED),
    MON("coyote", "土狼", S_DOG, LVL(1, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        2, CLR_BROWN),
    MON("werejackal", "豺狼人", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
    ...
    MON("little dog", "小狗", S_DOG, LVL(2, 18, 6, 0, 0), (G_GENO | 1),
        ...
        3, HI_DOMESTIC),
    MON("dingo", "澳洲野狗", S_DOG, LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 200, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        5, CLR_YELLOW),
    MON("dog", "狗", S_DOG, LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 200, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_DOMESTIC, M3_INFRAVISIBLE,
        5, HI_DOMESTIC),
    MON("large dog", "大狗", S_DOG, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
    ...
    MON("wolf", "狼", S_DOG, LVL(5, 12, 4, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 250, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        6, CLR_BROWN),
    MON("werewolf", "狼人", S_DOG, LVL(5, 12, 4, 20, -7), (G_NOGEN | G_NOCORPSE),
    ...
    MON("winter wolf cub", "冬狼崽", S_DOG, LVL(5, 12, 4, 0, -5),
    ...
    MON("warg", "座狼", S_DOG, LVL(7, 12, 4, 0, -5), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(850, 350, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        8, CLR_BROWN),
    MON("winter wolf", "冬狼", S_DOG, LVL(7, 12, 4, 20, 0), (G_NOHELL | G_GENO | 1),
        ...
        9, CLR_CYAN),
    MON("hell hound pup", "地狱小猎犬", S_DOG, LVL(7, 12, 4, 20, -5),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        9, CLR_RED),
    MON("hell hound", "地狱猎犬", S_DOG, LVL(12, 14, 2, 20, 0), (G_HELL | G_GENO | 1),
...
#ifdef CHARON
    MON("Cerberus", "刻耳柏洛斯", S_DOG, LVL(12, 10, 2, 20, -7),
     ...
     * eyes
     */
    MON("gas spore", "气体孢子", S_EYE, LVL(1, 3, 10, 0, 0), (G_NOCORPSE | G_GENO | 1),
    ...
    MON("floating eye", "浮眼", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 5),
    ...
    MON("freezing sphere", "冻结球", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("flaming sphere", "火焰球", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("shocking sphere", "电球", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("jaguar", "美洲豹", S_FELINE, LVL(4, 15, 6, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        6, CLR_BROWN),
    MON("lynx", "猞猁", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_CYAN),
    MON("panther", "黑豹", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_BLACK),
    MON("large cat", "大猫", S_FELINE, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 250, MS_MEW, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_STRONG | M2_DOMESTIC,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("tiger", "老虎", S_FELINE, LVL(6, 12, 6, 0, 0), (G_GENO | 2),
     ...
     */
    MON("gremlin", "小鬼", S_GREMLIN, LVL(5, 12, 2, 25, -9), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
        ...
        8, CLR_GREEN),
    MON("gargoyle", "石像鬼", S_GREMLIN, LVL(6, 10, -4, 0, -9), (G_GENO | 2),
        ...
        0, 8, CLR_BROWN),
    MON("winged gargoyle", "飞翼石像鬼", S_GREMLIN, LVL(9, 15, -2, 0, -12), (G_GENO | 1),
     ...
     * humanoids
     */
    MON("hobbit", "霍比特人", S_HUMANOID, LVL(1, 9, 10, 0, 6), (G_GENO | 2),
    ...
    MON("dwarf", "矮人", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
    ...
    MON("bugbear", "熊地精", S_HUMANOID, LVL(3, 9, 5, 0, -6), (G_GENO | 1),
    ...
    MON("dwarf lord", "矮人领主", S_HUMANOID, LVL(4, 6, 10, 10, 5), (G_GENO | 2),
    ...
    MON("dwarf king", "矮人王", S_HUMANOID, LVL(6, 6, 10, 20, 6), (G_GENO | 1),
    ...
    MON("mind flayer", "夺心魔", S_HUMANOID, LVL(9, 12, 5, 90, -8), (G_GENO | 1),
    ...
    MON("master mind flayer", "夺心魔大师", S_HUMANOID, LVL(13, 12, 0, 90, -8),
        (G_GENO | 1),
     ...
     */
    MON("manes", "灵魂", S_IMP, LVL(1, 3, 7, 0, -7),
    ...
    MON("homunculus", "雏形人", S_IMP, LVL(2, 12, 6, 10, -7), (G_GENO | 2),
    ...
    MON("quasit", "夸塞魔", S_IMP, LVL(3, 15, 2, 20, -7), (G_GENO | 2),
    ...
    MON("tengu", "天狗", S_IMP, LVL(6, 13, 5, 30, 7), (G_GENO | 3),
     ...
     * jellies
     */
    MON("blue jelly", "蓝色果冻", S_JELLY, LVL(4, 0, 8, 10, 0), (G_GENO | 2),
    ...
    MON("spotted jelly", "珍珠果冻", S_JELLY, LVL(5, 0, 8, 10, 0), (G_GENO | 1),
    ...
    MON("ochre jelly", "赭冻怪", S_JELLY, LVL(6, 3, 8, 20, 0), (G_GENO | 2),
     ...
     * kobolds
     */
    MON("kobold", "狗头人", S_KOBOLD, LVL(0, 6, 10, 0, -2), (G_GENO | 1),
    ...
    MON("large kobold", "大狗头人", S_KOBOLD, LVL(1, 6, 10, 0, -3), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(450, 150, MS_ORC, MZ_SMALL), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_OMNIVORE, M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 2, CLR_RED),
    MON("kobold lord", "狗头人领主", S_KOBOLD, LVL(2, 6, 10, 0, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("kobold shaman", "狗头人萨满", S_KOBOLD, LVL(2, 6, 6, 10, -4), (G_GENO | 1),
     ...
     * leprechauns
     */
    MON("leprechaun", "小矮妖", S_LEPRECHAUN, LVL(5, 15, 8, 20, 0), (G_GENO | 4),
     ...
     * nymphs
     */
    MON("wood nymph", "木仙女", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_GENO | 2),
     ...
     */
    MON("orc", "兽人", S_ORC, LVL(1, 9, 10, 0, -3), (G_GENO | G_NOGEN | G_LGROUP),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("orc-captain", "兽人队长", S_ORC, LVL(5, 5, 10, 0, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * piercers
     */
    MON("rock piercer", "岩石锥子", S_PIERCER, LVL(3, 1, 3, 0, 0), (G_GENO | 4),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("iron piercer", "铁锥子", S_PIERCER, LVL(5, 1, 0, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("glass piercer", "玻璃锥子", S_PIERCER, LVL(7, 1, 0, 0, 0), (G_GENO | 1),
     ...
     * quadrupeds
     */
    MON("rothe", "洛斯兽", S_QUADRUPED, LVL(2, 9, 7, 0, 0), (G_GENO | G_SGROUP | 4),
        ...
        4, CLR_BROWN),
    MON("mumak", "猛犸", S_QUADRUPED, LVL(5, 9, 0, 0, -2), (G_GENO | 1),
    ...
    MON("leocrotta", "狼狗", S_QUADRUPED, LVL(6, 18, 4, 10, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE, 8, CLR_RED),
    MON("wumpus", "狮头象", S_QUADRUPED, LVL(8, 3, 2, 10, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("titanothere", "雷兽", S_QUADRUPED, LVL(12, 12, 6, 0, 0), (G_GENO | 2),
    ...
    MON("baluchitherium", "俾路支兽", S_QUADRUPED, LVL(14, 12, 5, 0, 0), (G_GENO | 2),
    ...
    MON("mastodon", "乳齿象", S_QUADRUPED, LVL(20, 12, 5, 0, 0), (G_GENO | 1),
     ...
     * rodents
     */
    MON("sewer rat", "褐鼠", S_RODENT, LVL(0, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 12, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        1, CLR_BROWN),
    MON("giant rat", "巨鼠", S_RODENT, LVL(1, 10, 7, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        2, CLR_BROWN),
    MON("rabid rat", "狂鼠", S_RODENT, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
    ...
    MON("wererat", "鼠人", S_RODENT, LVL(2, 12, 6, 10, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(40, 30, MS_SQEEK, MZ_TINY), MR_POISON, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE, 4, CLR_BROWN),
    MON("rock mole", "岩石鼹鼠", S_RODENT, LVL(3, 3, 0, 20, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        4, CLR_GRAY),
    MON("woodchuck", "土拨鼠", S_RODENT, LVL(3, 3, 0, 20, 0), (G_NOGEN | G_GENO),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SILENT, MZ_SMALL), 0, 0,
     ...
     */
    MON("cave spider", "洞穴蜘蛛", S_SPIDER, LVL(1, 12, 3, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("centipede", "蜈蚣", S_SPIDER, LVL(2, 4, 3, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_DRST, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(50, 50, MS_SILENT, MZ_TINY), MR_POISON, MR_POISON,
        M1_CONCEAL | M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_CARNIVORE,
        M2_HOSTILE, 0, 4, CLR_YELLOW),
    MON("giant spider", "巨型蜘蛛", S_SPIDER, LVL(5, 15, 4, 0, 0), (G_GENO | 1),
    ...
    MON("scorpion", "蝎子", S_SPIDER, LVL(5, 15, 3, 0, 0), (G_GENO | 2),
     ...
     * trappers, lurkers, &c
     */
    MON("lurker above", "潜伏者", S_TRAPPER, LVL(10, 3, 3, 0, 0), (G_GENO | 2),
    ...
    MON("trapper", "捕兽者", S_TRAPPER, LVL(12, 3, 3, 0, 0), (G_GENO | 2),
     ...
     * unicorns and horses
     */
    MON("pony", "小马", S_UNICORN, LVL(3, 16, 6, 0, 0), (G_GENO | 2),
    ...
    MON("white unicorn", "白色独角兽", S_UNICORN, LVL(4, 24, 2, 70, 7), (G_GENO | 2),
    ...
    MON("gray unicorn", "灰色独角兽", S_UNICORN, LVL(4, 24, 2, 70, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE, 6, CLR_GRAY),
    MON("black unicorn", "黑色独角兽", S_UNICORN, LVL(4, 24, 2, 70, -7), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE, 6, CLR_BLACK),
    MON("horse", "马", S_UNICORN, LVL(5, 20, 5, 0, 0), (G_GENO | 2),
     ...
     * vortices
     */
    MON("fog cloud", "雾云", S_VORTEX, LVL(3, 1, 0, 0, 0), (G_GENO | G_NOCORPSE | 2),
    ...
    MON("dust vortex", "尘埃旋涡", S_VORTEX, LVL(4, 20, 2, 30, 0),
    ...
    MON("ice vortex", "冰旋涡", S_VORTEX, LVL(5, 20, 2, 30, 0),
    ...
    MON("energy vortex", "能量旋涡", S_VORTEX, LVL(6, 20, 2, 30, 0),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("steam vortex", "蒸汽旋涡", S_VORTEX, LVL(7, 22, 2, 30, 0),
    ...
    MON("fire vortex", "火旋涡", S_VORTEX, LVL(8, 22, 2, 30, 0),
    ...
    MON("purple worm", "紫蠕虫", S_WORM, LVL(15, 9, 6, 20, 0), (G_GENO | 2),
     ...
     * xan, &c
     */
    MON("grid bug", "电子虫", S_XAN, LVL(0, 12, 9, 0, 0),
    ...
    MON("xan", "玄蚊", S_XAN, LVL(7, 18, -4, 0, 0), (G_GENO | 3),
     ...
     * lights
     */
    MON("yellow light", "黄光", S_LIGHT, LVL(3, 15, 0, 0, 0),
    ...
    MON("black light", "黑光", S_LIGHT, LVL(5, 15, 0, 0, 0),
     ...
     * zruty
     */
    MON("zruty", "山区巨人", S_ZRUTY, LVL(9, 8, 3, 0, 0), (G_GENO | 2),
     ...
     */
    MON("couatl", "羽蛇", S_ANGEL, LVL(8, 10, 5, 30, 7),
    ...
    MON("Aleax", "亚历克斯", S_ANGEL, LVL(10, 8, 0, 30, 7), (G_NOHELL | G_NOCORPSE | 1),
    ...
    MON("Angel", "天使", S_ANGEL, LVL(14, 10, -4, 55, 12),
    ...
    MON("ki-rin", "麒麟", S_ANGEL, LVL(16, 18, -5, 90, 15),
        (G_NOHELL | G_NOCORPSE | 1),
    ...
    MON("Archon", "执政官", S_ANGEL, LVL(19, 16, -6, 80, 15),
        (G_NOHELL | G_NOCORPSE | 1),
    ...
    MON("vampire bat", "吸血蝙蝠", S_BAT, LVL(5, 20, 6, 0, 0), (G_GENO | 2),
     ...
     * Centaurs
     */
    MON("plains centaur", "平原半人马", S_CENTAUR, LVL(4, 18, 4, 0, 0), (G_GENO | 1),
    ...
    MON("forest centaur", "森林半人马", S_CENTAUR, LVL(5, 18, 3, 10, -1), (G_GENO | 1),
    ...
    MON("mountain centaur", "山半人马", S_CENTAUR, LVL(6, 20, 2, 10, -3), (G_GENO | 1),
     ...
     */
    MON("baby gray dragon", "幼灰龙", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby silver dragon", "幼银龙", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
...
#endif
    MON("baby red dragon", "幼红龙", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby yellow dragon", "幼黄龙", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("gray dragon", "灰龙", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
        ...
        0, 20, CLR_GRAY),
    MON("silver dragon", "银龙", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
    ...
    MON("shimmering dragon", S_DRAGON,
        ...
        0, 20, CLR_CYAN),
#endif
    MON("red dragon", "红龙", S_DRAGON, LVL(15, 9, -1, 20, -4), (G_GENO | 1),
    ...
    MON("white dragon", "白龙", S_DRAGON, LVL(15, 9, -1, 20, -5), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_COLD, 4, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
          ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
          NO_ATTK),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_WHITE),
    MON("orange dragon", "橙龙", S_DRAGON, LVL(15, 9, -1, 20, 5), (G_GENO | 1),
    ...
    MON("black dragon", "黑龙", S_DRAGON, LVL(15, 9, -1, 20, -6), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_BLACK),
    MON("blue dragon", "蓝龙", S_DRAGON, LVL(15, 9, -1, 20, -7), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_BLUE),
    MON("green dragon", "绿龙", S_DRAGON, LVL(15, 9, -1, 20, 6), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_GREEN),
    MON("yellow dragon", "黄龙", S_DRAGON, LVL(15, 9, -1, 20, 7), (G_GENO | 1),
     ...
     * Elementals
     */
    MON("stalker", "潜行者", S_ELEMENTAL, LVL(8, 12, 3, 0, 0), (G_GENO | 3),
        ...
        9, CLR_WHITE),
    MON("air elemental", "空气元素", S_ELEMENTAL, LVL(8, 36, 2, 30, 0), (G_NOCORPSE | 1),
    ...
    MON("fire elemental", "火元素", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | 1),
    ...
    MON("earth elemental", "土元素", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
    ...
    MON("water elemental", "水元素", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
     ...
     * Fungi
     */
    MON("lichen", "地衣", S_FUNGUS, LVL(0, 1, 9, 0, 0), (G_GENO | 4),
    ...
    MON("brown mold", "棕霉菌", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_COLD, 0, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("yellow mold", "黄霉菌", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 2),
    ...
    MON("green mold", "绿霉菌", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
    ...
    MON("red mold", "红霉菌", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
    ...
    MON("shrieker", "尖叫蕈", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 1),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 100, MS_SHRIEK, MZ_SMALL), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 2, CLR_MAGENTA),
    MON("violet fungus", "紫真菌", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 2),
    ...
    MON("gnomish wizard", "侏儒巫师", S_GNOME, LVL(3, 10, 4, 10, 0), (G_GENO | 1),
        A(ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(700, 120, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_GNOME | M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION, 5, HI_ZAP),
    MON("gnome king", "侏儒王", S_GNOME, LVL(5, 10, 10, 20, 0), (G_GENO | 1),
...
struct permonst _mons2[] = {
     ...
     * giant Humanoids
     */
    MON("giant", "巨人", S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_NOGEN | 1),
    ...
    MON("stone giant", "石头巨人", S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT
    ...
    MON("hill giant", "丘陵巨人", S_GIANT, LVL(8, 10, 6, 0, -2), (G_GENO | G_SGROUP | 1),
    ...
    MON("fire giant", "火巨人", S_GIANT, LVL(9, 12, 4, 5, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("frost giant", "霜巨人", S_GIANT, LVL(10, 12, 3, 10, -3),
    ...
    MON("ettin", "双头巨人", S_GIANT, LVL(10, 12, 3, 0, 0), (G_GENO | 1),
    ...
    MON("storm giant", "风暴巨人", S_GIANT, LVL(16, 12, 3, 10, -3),
    ...
    MON("titan", "提坦", S_GIANT, LVL(16, 18, -3, 70, 9), (1),
    ...
    MON("minotaur", "弥诺陶洛斯", S_GIANT, LVL(15, 15, 6, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("jabberwock", "颊脖龙", S_JABBERWOCK, LVL(15, 12, -2, 50, 0), (G_GENO | 1),
     ...
     * Kops
     */
    MON("Keystone Kop", "吉斯通警察", S_KOP, LVL(1, 6, 10, 10, 9),
    ...
    MON("Kop Sergeant", "吉斯通警司", S_KOP, LVL(2, 8, 10, 10, 10),
    ...
    MON("Kop Lieutenant", "吉斯通警督", S_KOP, LVL(3, 10, 10, 20, 11), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_HUMAN | M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE, 5, CLR_CYAN),
    MON("Kop Kaptain", "吉斯通警监", S_KOP, LVL(4, 12, 10, 20, 12), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_HUMAN | M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT,
     ...
     * Liches
     */
    MON("lich", "巫妖", S_LICH, LVL(11, 6, 0, 30, -9), (G_GENO | G_NOCORPSE | 1),
    ...
    MON("demilich", "半巫妖", S_LICH, LVL(14, 9, -2, 60, -12),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("master lich", "巫妖大师", S_LICH, LVL(17, 9, -4, 90, -15),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
        ...
        21, HI_LORD),
    MON("arch-lich", "大巫妖", S_LICH, LVL(25, 9, -6, 90, -15),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
     ...
     * Mummies
     */
    MON("kobold mummy", "狗头人木乃伊", S_MUMMY, LVL(3, 8, 6, 20, -2),
    ...
    MON("gnome mummy", "侏儒木乃伊", S_MUMMY, LVL(4, 10, 6, 20, -3),
    ...
    MON("orc mummy", "兽人木乃伊", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("dwarf mummy", "矮人木乃伊", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("elf mummy", "精灵木乃伊", S_MUMMY, LVL(6, 12, 4, 30, -5),
    ...
    MON("human mummy", "人类木乃伊", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("ettin mummy", "双头木乃伊", S_MUMMY, LVL(7, 12, 4, 30, -6),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("giant mummy", "巨人木乃伊", S_MUMMY, LVL(8, 14, 3, 30, -7),
        (G_GENO | G_NOCORPSE | 1),
     ...
     * Nagas
     */
    MON("red naga hatchling", "红幼纳迦", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("black naga hatchling", "黑幼纳迦", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("golden naga hatchling", "金幼纳迦", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
        M2_STRONG, 0, 4, HI_GOLD),
    MON("guardian naga hatchling", "幼纳迦守卫", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
        M2_STRONG, 0, 4, CLR_GREEN),
    MON("red naga", "红纳迦", S_NAGA, LVL(6, 12, 4, 0, -4), (G_GENO | 1),
    ...
    MON("black naga", "黑纳迦", S_NAGA, LVL(8, 14, 2, 10, 4), (G_GENO | 1),
    ...
    MON("golden naga", "金纳迦", S_NAGA, LVL(10, 14, 2, 70, 5), (G_GENO | 1),
    ...
    MON("guardian naga", "纳迦守卫", S_NAGA, LVL(12, 16, 0, 50, 7), (G_GENO | 1),
     ...
     * Ogres
     */
    MON("ogre", "食人魔", S_OGRE, LVL(5, 10, 5, 0, -3), (G_SGROUP | G_GENO | 1),
    ...
    MON("ogre lord", "食人魔领主", S_OGRE, LVL(7, 12, 3, 30, -5), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("ogre king", "食人魔王", S_OGRE, LVL(9, 14, 4, 60, -7), (G_GENO | 2),
     ...
     */
    MON("gray ooze", "灰色软泥", S_PUDDING, LVL(3, 1, 8, 0, 0), (G_GENO | G_NOCORPSE | 2),
        ...
        M2_HOSTILE | M2_NEUTER, 0, 4, CLR_GRAY),
    MON("brown pudding", "棕色布丁", S_PUDDING, LVL(5, 3, 8, 0, 0),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER, 0, 6, CLR_BROWN),
    MON("green slime", "绿色黏液", S_PUDDING, LVL(6, 6, 6, 0, 0),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
    ...
    MON("black pudding", "黑色布丁", S_PUDDING, LVL(10, 6, 6, 0, 0),
        (G_GENO | G_NOCORPSE | 1),
     ...
     * Quantum mechanics
     */
    MON("quantum mechanic", "量子力学", S_QUANTMECH, LVL(7, 12, 3, 10, 0), (G_GENO | 3),
     ...
     */
    MON("rust monster", "锈怪", S_RUSTMONST, LVL(5, 18, 2, 0, 0), (G_GENO | 2),
    ...
    MON("disenchanter", "解魔怪", S_RUSTMONST, LVL(12, 12, -10, 0, -3),
        (G_HELL | G_GENO | 2),
     ...
     * Snakes
     */
    MON("garter snake", "束带蛇", S_SNAKE, LVL(1, 8, 8, 0, 0), (G_LGROUP | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        0, 0, 3, CLR_GREEN),
    MON("snake", "蛇", S_SNAKE, LVL(4, 15, 3, 0, 0), (G_GENO | 2),
        ...
        M1_SWIM | M1_CONCEAL | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_POIS
            | M1_OVIPAROUS | M1_CARNIVORE | M1_NOTAKE,
        M2_HOSTILE, 0, 6, CLR_BROWN),
    MON("water moccasin", "水蝮蛇", S_SNAKE, LVL(4, 15, 3, 0, 0),
    ...
    MON("python", "巨蟒", S_SNAKE, LVL(6, 3, 5, 0, 0), (G_GENO | 1),
    ...
    MON("pit viper", "响尾蛇", S_SNAKE, LVL(6, 15, 2, 0, 0), (G_GENO | 1),
    ...
    MON("cobra", "眼镜蛇", S_SNAKE, LVL(6, 18, 2, 0, 0), (G_GENO | 1),
     ...
     * Trolls
     */
    MON("troll", "巨魔", S_TROLL, LVL(7, 12, 4, 0, -3), (G_GENO | 2),
        ...
        9, CLR_BROWN),
    MON("ice troll", "冰巨魔", S_TROLL, LVL(9, 10, 2, 20, -3), (G_NOHELL | G_GENO | 1),
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        12, CLR_WHITE),
    MON("rock troll", "岩石巨魔", S_TROLL, LVL(9, 12, 0, 0, -3), (G_GENO | 1),
    ...
    MON("water troll", "水巨魔", S_TROLL, LVL(11, 14, 4, 40, -3), (G_NOGEN | G_GENO),
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        13, CLR_BLUE),
    MON("Olog-hai", "欧罗海", S_TROLL, LVL(13, 12, -4, 0, -7), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * Umber hulk
     */
    MON("umber hulk", "土巨怪", S_UMBER, LVL(9, 6, 2, 25, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
     ...
     * Vampires
     */
    MON("vampire", "吸血鬼", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("vampire lord", "吸血鬼领主", S_VAMPIRE, LVL(12, 14, 0, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
...
#endif
    MON("Vlad the Impaler", "穿刺者弗拉德", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
     ...
     * Wraiths
     */
    MON("barrow wight", "古墓尸妖", S_WRAITH, LVL(3, 12, 5, 5, -3),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("wraith", "幽灵", S_WRAITH, LVL(6, 12, 4, 15, -6), (G_GENO | 2),
    ...
    MON("Nazgul", "戒灵", S_WRAITH, LVL(13, 12, 0, 25, -17),
        (G_GENO | G_NOCORPSE | 1),
     ...
     * Xorn
     */
    MON("xorn", "索尔石怪", S_XORN, LVL(8, 9, -2, 20, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
    ...
    MON("monkey", "猴子", S_YETI, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
    ...
    MON("ape", "猿", S_YETI, LVL(4, 12, 6, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
        ...
        6, CLR_BROWN),
    MON("owlbear", "枭熊", S_YETI, LVL(5, 12, 5, 0, 0), (G_GENO | 3),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
     ...
     * Zombies
     */
    MON("kobold zombie", "狗头人僵尸", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, 1, CLR_BROWN),
    MON("gnome zombie", "侏儒僵尸", S_ZOMBIE, LVL(1, 6, 10, 0, -2),
        ...
        2, CLR_BROWN),
    MON("orc zombie", "兽人僵尸", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        CLR_GRAY),
    MON("dwarf zombie", "矮人僵尸", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(900, 150, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        ...
        3, CLR_RED),
    MON("elf zombie", "精灵僵尸", S_ZOMBIE, LVL(3, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        ...
        4, CLR_GREEN),
    MON("human zombie", "人类僵尸", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
    ...
    MON("ettin zombie", "双头僵尸", S_ZOMBIE, LVL(6, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        ...
        7, CLR_BLUE),
    MON("ghoul", "食尸鬼", S_ZOMBIE, LVL(3, 6, 10, 0, -2), (G_GENO | G_NOCORPSE | 1),
    ...
    MON("giant zombie", "巨人僵尸", S_ZOMBIE, LVL(8, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("skeleton", "骷髅", S_ZOMBIE, LVL(12, 8, 4, 0, 0), (G_NOCORPSE | G_NOGEN),
     ...
     * golems
     */
    MON("straw golem", "稻草魔像", S_GOLEM, LVL(3, 12, 10, 0, 0), (G_NOCORPSE | 1),
        ...
        4, CLR_YELLOW),
    MON("paper golem", "纸魔像", S_GOLEM, LVL(3, 12, 10, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 0, MS_SILENT, MZ_LARGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER, 0,
        4, HI_PAPER),
    MON("rope golem", "绳子魔像", S_GOLEM, LVL(4, 9, 8, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_HUGS, AD_PHYS, 6, 1), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(450, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER, 0,
        6, CLR_BROWN),
    MON("gold golem", "金魔像", S_GOLEM, LVL(5, 9, 6, 0, 0), (G_NOCORPSE | 1),
    ...
    MON("flesh golem", "肉魔像", S_GOLEM, LVL(9, 8, 9, 30, 0), (1),
        ...
        10, CLR_RED),
    MON("clay golem", "土魔像", S_GOLEM, LVL(11, 7, 7, 40, 0), (G_NOCORPSE | 1),
    ...
    MON("stone golem", "石魔像", S_GOLEM, LVL(14, 6, 5, 50, 0), (G_NOCORPSE | 1),
    ...
    MON("glass golem", "玻璃魔像", S_GOLEM, LVL(16, 6, 1, 50, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON | MR_ACID, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 18, CLR_CYAN),
    MON("iron golem", "铁魔像", S_GOLEM, LVL(18, 6, 3, 60, 0), (G_NOCORPSE | 1),
     ...
     */
    MON("human", "人", S_HUMAN, LVL(0, 12, 10, 0, 0), G_NOGEN, /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        2, HI_DOMESTIC),
    MON("wererat", "鼠人", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("werejackal", "豺狼人", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
    ...
    MON("werewolf", "狼人", S_HUMAN, LVL(5, 12, 10, 20, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
    ...
    MON("elf", "精灵", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("Woodland-elf", "伍德兰精灵", S_HUMAN, LVL(4, 12, 10, 10, -5),
    ...
    MON("Green-elf", "绿精灵", S_HUMAN, LVL(5, 12, 10, 10, -6), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 7, CLR_BRIGHT_GREEN),
    MON("Grey-elf", "灰精灵", S_HUMAN, LVL(6, 12, 10, 10, -7), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 8, CLR_GRAY),
    MON("elf-lord", "精灵领主", S_HUMAN, LVL(8, 12, 10, 20, -9), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
    ...
    MON("Elvenking", "精灵王", S_HUMAN, LVL(9, 12, 10, 25, -10), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, HI_LORD),
    MON("doppelganger", "变形人", S_HUMAN, LVL(9, 12, 5, 20, 0), (G_GENO | 1),
    ...
    MON("shopkeeper", "店主", S_HUMAN, LVL(12, 18, 0, 50, 0), G_NOGEN,
    ...
    MON("guard", "警卫", S_HUMAN, LVL(12, 12, 10, 40, 10), G_NOGEN,
        ...
        M3_INFRAVISIBLE, 14, CLR_BLUE),
    MON("prisoner", "囚犯", S_HUMAN, LVL(12, 12, 10, 0, 0),
    ...
    MON("Oracle", "神谕", S_HUMAN, LVL(12, 0, 0, 50, 0), (G_NOGEN | G_UNIQ),
    ...
    /* aligned priests always have the epri extension attached;
       ...
       or isminion set */
    MON("aligned priest", "虔诚的牧师", S_HUMAN, LVL(12, 12, 10, 50, 0), G_NOGEN,
    ...
    MON("high priest", "高级祭司", S_HUMAN, LVL(25, 15, 7, 70, 0), (G_NOGEN | G_UNIQ),
    ...
    MON("sergeant", "中士", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
    ...
    MON("nurse", "护士", S_HUMAN, LVL(11, 6, 0, 0, 0), (G_GENO | 3),
    ...
    MON("lieutenant", "中尉", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
    ...
    MON("captain", "上尉", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
     ...
     */
    MON("watchman", "警卫员", S_HUMAN, LVL(6, 10, 10, 0, -2),
        ...
        M3_INFRAVISIBLE, 8, CLR_GRAY),
    MON("watch captain", "警卫员队长", S_HUMAN, LVL(10, 10, 10, 15, -4),
        (G_NOGEN | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
     ...
     */
    MON("Medusa", "美杜莎", S_HUMAN, LVL(20, 12, 2, 50, -15), (G_NOGEN | G_UNIQ),
    ...
    MON("Wizard of Yendor", "岩德巫师", S_HUMAN, LVL(30, 12, -8, 100, A_NONE),
        (G_NOGEN | G_UNIQ),
    ...
    MON("Croesus", "克罗伊斯", S_HUMAN, LVL(20, 15, 0, 40, 15), (G_UNIQ | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARD, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
...
#ifdef CHARON
    MON("Charon", "卡隆", S_HUMAN, LVL(76, 18, -5, 120, 0),
     ...
     * ghosts
     */
    MON("ghost", "鬼魂", S_GHOST, LVL(10, 3, -5, 50, -5), (G_NOCORPSE | G_NOGEN),
        ...
        12, CLR_GRAY),
    MON("shade", "魂灵", S_GHOST, LVL(12, 10, 10, 0, 0), (G_NOCORPSE | G_NOGEN),
     ...
     * (major) demons
     */
    MON("water demon", "水妖", S_DEMON, LVL(8, 12, -4, 30, -7),
        (G_NOCORPSE | G_NOGEN),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("succubus", "魅魔", S_DEMON, LVL(6, 12, 0, 70, -9), (G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 8, CLR_GRAY),
    MON("horned devil", "有角的魔鬼", S_DEMON, LVL(6, 9, -5, 50, 11),
        (G_HELL | G_NOCORPSE | 2),
    ...
    MON("incubus", "梦魇", S_DEMON, LVL(6, 12, 0, 70, -9), (G_NOCORPSE | 1),
        SEDUCTION_ATTACKS_YES, SIZ(WT_HUMAN, 400, MS_SEDUCE, MZ_HUMAN),
        MR_FIRE | MR_POISON, 0, M1_HUMANOID | M1_FLY | M1_POIS,
    ...
    MON("erinys", "伊里逆丝", S_DEMON, LVL(7, 12, 2, 30, 10),
    ...
    MON("barbed devil", "哈玛魔", S_DEMON, LVL(8, 12, 0, 35, 8),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
        ...
        M1_POIS | M1_THICK_HIDE, M2_DEMON | M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 10, CLR_RED),
    MON("marilith", "六臂蛇魔", S_DEMON, LVL(7, 12, -6, 80, -12),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
    ...
    MON("vrock", "弗洛魔", S_DEMON, LVL(8, 12, 0, 50, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_RED),
    MON("hezrou", "狂战魔", S_DEMON, LVL(9, 6, -2, 55, -10),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
    ...
    MON("bone devil", "骨魔", S_DEMON, LVL(9, 15, -1, 40, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
    ...
    MON("ice devil", "冰魔", S_DEMON, LVL(11, 6, -4, 55, -12),
        (G_HELL | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON("nalfeshnee", "判魂魔", S_DEMON, LVL(11, 9, -1, 65, -11),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON("pit fiend", "深渊恶魔", S_DEMON, LVL(13, 6, -3, 65, -13),
        (G_HELL | G_NOCORPSE | 2),
    ...
    MON("sandestin", "桑德斯廷", S_DEMON, LVL(13, 12, 4, 60, -5),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("balrog", "炎魔", S_DEMON, LVL(16, 5, -2, 75, -14), (G_HELL | G_NOCORPSE | 1),
     ...
     */
    MON("Juiblex", "朱比烈斯", S_DEMON, LVL(50, 3, -7, 65, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON("Yeenoghu", "伊诺胡", S_DEMON, LVL(56, 18, -5, 80, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON("Orcus", "奥迦斯", S_DEMON, LVL(66, 9, -6, 85, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WAITFORU | M3_WANTSBOOK | M3_WANTSAMUL | M3_INFRAVISIBLE
            | M3_INFRAVISION,
        36, HI_LORD),
    MON("Geryon", "吉里昂", S_DEMON, LVL(72, 3, -3, 75, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
    ...
    MON("Dispater", "迪斯帕特", S_DEMON, LVL(78, 15, -2, 80, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON("Baalzebub", "巴力西卜", S_DEMON, LVL(89, 9, -5, 85, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        45, HI_LORD),
    MON("Asmodeus", "阿斯莫德", S_DEMON, LVL(105, 12, -7, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WANTSAMUL | M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION,
        53, HI_LORD),
    MON("Demogorgon", "狄摩高根", S_DEMON, LVL(106, 15, -8, 95, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
     ...
     */
    MON("Death", "死亡", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
    ...
    MON("Pestilence", "瘟疫", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        ...
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_PNAME | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_DISPLACES, 34, HI_LORD),
    MON("Famine", "饥荒", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
     ...
     */
#ifdef MAIL
    MON("mail daemon", "邮件幽灵程序", S_DEMON, LVL(56, 24, 10, 127, 0),
        (G_NOGEN | G_NOCORPSE),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        26, CLR_BRIGHT_BLUE),
#endif
    MON("djinni", "灯神", S_DEMON, LVL(7, 12, 4, 30, 0), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     * sea monsters
     */
    MON("jellyfish", "水母", S_EEL, LVL(3, 3, 6, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("piranha", "水虎鱼", S_EEL, LVL(5, 12, 4, 0, 0), (G_GENO | G_NOGEN | G_SGROUP),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("shark", "鲨鱼", S_EEL, LVL(7, 12, 2, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("giant eel", "巨型鳗鱼", S_EEL, LVL(5, 9, -1, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("electric eel", "电鳗", S_EEL, LVL(7, 10, -3, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("kraken", "海妖", S_EEL, LVL(20, 3, 6, 0, -3), (G_GENO | G_NOGEN),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
    ...
    MON("crocodile", "鳄鱼", S_LIZARD, LVL(6, 9, 5, 0, 0), (G_GENO | 1),
    ...
    MON("salamander", "火蜥蜴", S_LIZARD, LVL(8, 12, -1, 0, -9), (G_HELL | 1),
     ...
     */
    MON("long worm tail", "长蠕虫尾", S_WORM_TAIL, LVL(0, 0, 0, 0, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * character classes
     */
    MON("archeologist", "考古学家", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("barbarian", "野蛮人", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("caveman", "穴居人", S_HUMAN, LVL(10, 12, 10, 0, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("cavewoman", "女穴居人", S_HUMAN, LVL(10, 12, 10, 0, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        ...
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("healer", "医生", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("knight", "骑士", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("monk", "僧侣", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
        ...
        M3_INFRAVISIBLE, 11, HI_DOMESTIC),
    MON("priest", "牧师", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("priestess", "女牧师", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("ranger", "游侠", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("rogue", "盗贼", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        ...
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("samurai", "武士", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("tourist", "游客", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("valkyrie", "女武神", S_HUMAN, LVL(10, 12, 10, 1, -1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("wizard", "巫师", S_HUMAN, LVL(10, 12, 10, 3, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
     ...
     * quest leaders
     */
    MON("Lord Carnarvon", "卡那封勋爵", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("Pelias", "珀利阿斯", S_HUMAN, LVL(20, 12, 0, 30, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 22, HI_LORD),
    MON("Shaman Karnov", "萨满卡诺夫", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Elwing", S_HUMAN,
        ...
        M3_CLOSE | M3_INFRAVISION | M3_INFRAVISIBLE, 22, HI_LORD),
#endif
    MON("Hippocrates", "希波克拉底", S_HUMAN, LVL(20, 12, 0, 40, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 22, HI_LORD),
    MON("King Arthur", "亚瑟王", S_HUMAN, LVL(20, 12, 0, 40, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Grand Master", "宗师", S_HUMAN, LVL(25, 12, 0, 70, 0), (G_NOGEN | G_UNIQ),
    ...
    MON("Arch Priest", "大祭司", S_HUMAN, LVL(25, 12, 7, 70, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_KICK, AD_PHYS, 2, 8),
          ATTK(AT_MAGC, AD_CLRC, 2, 8), ATTK(AT_MAGC, AD_CLRC, 2, 8), NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN),
    ...
    MON("Orion", "俄里翁", S_HUMAN, LVL(20, 12, 0, 30, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     */
    MON("Master of Thieves", "盗贼大师", S_HUMAN, LVL(20, 12, 0, 30, -20),
        (G_NOGEN | G_UNIQ),
    ...
    MON("Lord Sato", "萨托领主", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 23, HI_LORD),
    MON("Twoflower", "双花", S_HUMAN, LVL(20, 12, 10, 20, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Norn", "诺恩", S_HUMAN, LVL(20, 12, 0, 80, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_FEMALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 23, HI_LORD),
    MON("Neferet the Green", "绿衣娜菲利特", S_HUMAN, LVL(20, 12, 0, 60, 0),
        (G_NOGEN | G_UNIQ),
     ...
     * quest nemeses
     */
    MON("Minion of Huhetotl", "修堤库特里的奴才", S_DEMON, LVL(16, 12, -2, 75, -14),
        ...
        23, CLR_RED),
    MON("Thoth Amon", "图特阿蒙", S_HUMAN, LVL(16, 12, 0, 10, -14),
     ...
     */
    MON("Chromatic Dragon", "彩色龙", S_DRAGON, LVL(16, 12, 0, 30, -14),
        (G_NOGEN | G_UNIQ),
    ...
    MON("Goblin King", S_ORC,
        ...
        18, HI_LORD),
#endif
    MON("Cyclops", "独眼巨人", S_GIANT, LVL(18, 12, 0, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE,
        23, CLR_GRAY),
    MON("Ixoth", "恶龙", S_DRAGON, LVL(15, 12, -1, 20, -14), (G_NOGEN | G_UNIQ),
    ...
    MON("Master Kaen", "凯恩大师", S_HUMAN, LVL(25, 12, -10, 10, -20), (G_NOGEN | G_UNIQ),
    ...
    MON("Nalzok", "纳宗魔", S_DEMON, LVL(16, 12, -2, 85, -127),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 4, 6),
          ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK,
          NO_ATTK),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE,
        23, CLR_RED),
    MON("Scorpius", "蝎弩", S_SPIDER, LVL(15, 12, 10, 0, -15), (G_NOGEN | G_UNIQ),
    ...
    MON("Master Assassin", "刺客大师", S_HUMAN, LVL(15, 12, 0, 30, 18),
        (G_NOGEN | G_UNIQ),
     ...
     * of his time.
     */
    MON("Ashikaga Takauji", "足利尊氏", S_HUMAN, LVL(15, 12, 0, 40, -13),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
          ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
     ...
     */
    MON("Lord Surtur", "叙尔特领主", S_GIANT, LVL(15, 12, 2, 50, 12), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE,
        19, HI_LORD),
    MON("Dark One", "黑暗魔君", S_HUMAN, LVL(15, 12, 0, 80, -10),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
     ...
     * quest "guardians"
     */
    MON("student", "学者", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("chieftain", "酋长", S_HUMAN, LVL(5, 12, 10, 10, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("neanderthal", "尼安德特人", S_HUMAN, LVL(5, 12, 10, 10, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
...
#endif
    MON("attendant", "护理者", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("page", "实习骑士", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("abbot", "方丈", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
    ...
    MON("acolyte", "侍祭", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 8, HI_DOMESTIC),
    MON("hunter", "猎人", S_HUMAN, LVL(5, 12, 10, 10, -7), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISION | M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("thug", "刺客", S_HUMAN, LVL(5, 12, 10, 10, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
        ...
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("ninja", "忍者", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("roshi", "禅师", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("guide", "导游", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
                                       | M2_STRONG | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, 8, HI_DOMESTIC),
    MON("warrior", "战士", S_HUMAN, LVL(5, 12, 10, 10, -1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
        ...
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("apprentice", "魔法学徒", S_HUMAN, LVL(5, 12, 10, 30, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
