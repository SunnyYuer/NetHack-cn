 ...
 */
#define MON(enam, nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, col) \
    {                                                                      \
        enam, nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, C(col)   \
    }
...
struct permonst _mons2[] = {
     ...
     */
    MON("gray ooze", "灰泥怪", S_PUDDING, LVL(3, 1, 8, 0, 0), (G_GENO | G_NOCORPSE | 2),
